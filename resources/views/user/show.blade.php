                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <ul class="nav nav-tabs mb-2" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center" id="pengurus-tab" data-toggle="tab" href="#pengurus" aria-controls="information" role="tab" aria-selected="false">
                                            <i class="step-icon fa fa-files-o mr-25"></i><span class="d-none d-sm-block">Riwayat Pengurus Organisasi (Periode)</span>
                                        </a>
                                    </li>
                                </ul>
